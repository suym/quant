...
# -*- coding: utf-8 -*-
'''
model_cla_GradientBoostingClassifier.py
'''

from sklearn.model_selection import train_test_split
from tools import GS_GradientBoostingClassifier
...
if __name__ == "__main__":
    ...
    results = GS_GradientBoostingClassifier(X_train, X_test, y_train, y_test)
