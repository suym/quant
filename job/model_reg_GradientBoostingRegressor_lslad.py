...
# -*- coding: utf-8 -*-
'''
model_reg_GradientBoostingRegressor_lslad.py
'''

from sklearn.model_selection import train_test_split
from tools import GS_GradientBoostingRegressor_lslad
...
if __name__ == "__main__":
    ...
    results = GS_GradientBoostingRegressor_lslad(X_train, X_test, y_train, y_test)
